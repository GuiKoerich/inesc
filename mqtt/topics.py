topics = [
    ...
    'topic_sala/atualizacao', 'topic_Imp3D/sensor/temperatura', 'topic_Imp3D/sensor/umidade',
    'topic_Armaz/sensor/temperatura', 'topic_Armaz/sensor/umidade', 'topic_Imp3D/impressao/atual',
    'topic_Imp3D/impressao/tamanho', 'topic_Imp3D/arquivo', 'topic_Imp3D/status', 'topic_Imp3D/tempo/total',
    'topic_Imp3D/tempo/restante', 'topic_Imp3D/sensor/temp_extrude', 'topic_Imp3D/sensor/temp_bed',
    ...
    'topic_Imp3D/config/frequencia', 'topic_Imp3D/config/habilitar', 'topic_Armaz/config/frequencia',
    'topic_Armaz/config/habilitar', 'topic_Alarmes/erro/Sala/temp', 'topic_Alarmes/erro/Sala/umid',
